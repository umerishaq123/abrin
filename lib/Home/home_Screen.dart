...
class _HomeScreenState extends State<HomeScreen> {
  ...
  void initState() {
    super.initState();
    _fetchBusinesses();
    final viewModel = Provider.of<SessionHandlingViewModel>(context, listen: false);
 ...
 @override
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
        body:
         ...
         Consumer<SessionHandlingViewModel>(
           builder: (context, viewModel, child) {
             ...
             return BottomNavBar(
               ...
               pages: [
                 ...
                 EventListScreen(),
                 BookmarkedScreen(),
                 loggedIn ?  AccountScreen():LoginPage(islogin: false,) ,
               ],
             );
           },
         ),
  ...
  child: GestureDetector(
    onTap: () {
      ...
      print("::: presses");
      final bottomNavBarState = bottomNavBarKey.currentState;
      if (bottomNavBarState != null) {
        print("::: not null");
        bottomNavBarState.setPage(1); // Change to the search screen
      } else {
        print("::: BottomNavBarState is null");
      }
    },
    child: AbsorbPointer( // Prevents user input
      child: TextFormField(
  ...
  final highlightedBusinesses = filteredBusinesses.where((business) => business.isHighlighted ?? false).toList();

    return SizedBox(
      height: MediaQuery.of(context).size.height*0.35,
      width: double.infinity,
      child: isLoading?Center(child: CircularProgressIndicator(),): highlightedBusinesses.isEmpty
        ? Center(
            child: Text(
